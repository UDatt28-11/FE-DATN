          ...
          <Row gutter={[60, 40]} align="middle">
            <Col xs={24} lg={12}>
              <div style={{ marginBottom: 100 }}>
                ...
                >
                  Nằm giữa thiên nhiên yên bình, homestay của chúng tôi là nơi
                  lý tưởng để bạn thư giãn và tận hưởng khoảng thời gian nghỉ
                  dưỡng tuyệt vời. Với không gian ấm cúng, phòng ốc tiện nghi và
                  dịch vụ tận tâm, chúng tôi cam kết mang đến cho bạn trải
                  nghiệm lưu trú như ở nhà, đầy ấm áp và thân thiện. Homestay
                  được thiết kế với phong cách hiện đại kết hợp truyền thống,
                  mang đến sự hài hòa giữa tiện nghi đô thị và nét đẹp văn hóa
                  địa phương.
                </Paragraph>
                <Link
                  to="/rooms"
          ...
          <Row justify="center">
            <Col xs={24} lg={16}>
              <div style={{ textAlign: "center", marginBottom: 60 }}>
                ...
                >
                  Với nhiều năm kinh nghiệm trong lĩnh vực lưu trú, chúng tôi tự
                  hào đã phục vụ hàng nghìn khách hàng từ khắp nơi trên cả nước.
                  Homestay của chúng tôi không chỉ là nơi nghỉ ngơi mà còn là
                  điểm đến lý tưởng để bạn tận hưởng những khoảnh khắc đáng nhớ
              ...
              <div style={{ textAlign: "center", marginBottom: 100 }}>
                ...
                >
                  ...
                  >
                    ...
                    {/* Heart */}
                    <path
                      d="M26 50c-3-2-6-1-7 2s1 6 7 10c6-4 8-7 7-10s-4-4-7-2z"
                      fill="#d4af37"
                      stroke="none"
                    />
                    <path
                      d="M38 50c-3-2-6-1-7 2s1 6 7 10c6-4 8-7 7-10s-4-4-7-2z"
                      fill="#d4af37"
                      stroke="none"
                    />
                  </svg>
          ...
          <Row>
            <Col span={24}>
              <div style={{ textAlign: "center", marginBottom: 50 }}>
                ...
                <Title
                  level={2}
                  style={{ fontSize: 36, fontWeight: 700, color: "#303030" }}
                >
              ...
              <div style={styles.singleHotelInfo}>
                <div style={styles.hotelInfoText}>
                  ...
                  >
                    ...
                    />
                    <Text style={{ fontSize: 15, color: "#303030" }}>
                      Phòng trang bị đầy đủ tiện nghi
                    </Text>
                  </div>
                  <div
                    style={{
            ...
            <Col span={24}>
              <div style={{ textAlign: "center" }}>
                ...
                >
                  ...
                  >
                    "Homestay thật sự tuyệt vời! Không gian ấm cúng, sạch sẽ và
                    đầy đủ tiện nghi. Chủ nhà rất nhiệt tình và thân thiện, giúp
                    chúng tôi có những trải nghiệm tuyệt vời trong chuyến du
                    lịch. Vị trí thuận lợi, gần trung tâm nhưng vẫn yên tĩnh.
                    Chắc chắn sẽ quay lại vào lần tới!"
                  </Paragraph>
                  <Title
                    level={5}
                    style={{ color: "#303030", fontSize: 16, marginBottom: 20 }}
                  >
                    Nguyễn Văn A,{" "}
                    <span style={{ color: "#7d7d7d", fontWeight: 400 }}>
                      Khách hàng
                    </span>
                  </Title>
                  <img
