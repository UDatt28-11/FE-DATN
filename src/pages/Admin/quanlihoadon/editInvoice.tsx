...
import type { UpdateInvoiceData, Invoice, InvoiceItem } from "../../../types/invoice/invoice";
  ...
  const fetchInvoice = async () => {
    ...
    try {
      ...
      form.setFieldsValue({
        ...
        issue_date: invoiceData.issue_date ? dayjs(invoiceData.issue_date) : dayjs(),
        due_date: invoiceData.due_date ? dayjs(invoiceData.due_date) : dayjs().add(7, "day"),
