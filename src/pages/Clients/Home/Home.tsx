  ...
  const heroSlides = [
    {
      ...
      description:
        "Khám phá không gian nghỉ dưỡng đẳng cấp với thiết kế sang trọng, tiện nghi hiện đại và dịch vụ tận tâm. Nơi mọi khoảnh khắc đều trở nên đáng nhớ.",
    },
    {
      image: "/img/bg-img/bg-2.jpg",
      title: "Nơi Đáng Nhớ",
      description:
        "Tận hưởng những trải nghiệm tuyệt vời cùng gia đình và người thân. Mỗi phòng là một câu chuyện, mỗi khoảnh khắc là một kỷ niệm.",
    },
    {
      image: "/img/bg-img/bg-3.jpg",
      title: "Tận Hưởng Cuộc Sống",
      description:
        "Hãy để chúng tôi chăm sóc mọi chi tiết để bạn có thể thư giãn hoàn toàn. Trải nghiệm sự kết hợp hoàn hảo giữa thiên nhiên và tiện nghi hiện đại.",
    },
  ];
  ...
  return (
    ...
    >
      ...
      <section className="hero-area">
        <Carousel autoplay effect="fade" className="hero-slides" dots={true}>
          ...
          <Row align="middle" gutter={[30, 30]}>
            <Col xs={24} lg={12}>
              <div className="about-text text-center mb-100" data-aos="fade-up">
                ...
                <p>
                  Chào mừng đến với khách sạn của chúng tôi - nơi kết hợp hoàn
                  hảo giữa sự sang trọng và ấm cúng. Với đội ngũ nhân viên
                  chuyên nghiệp, tiện nghi hiện đại và dịch vụ tận tâm, chúng
                  tôi cam kết mang đến cho bạn những trải nghiệm lưu trú tuyệt
                  vời nhất. Mỗi chi tiết đều được chăm chút kỹ lưỡng để tạo nên
      ...
      <section
        ...
        style={{ backgroundImage: "url(/img/bg-img/4.png)" }}
      >
        <div className="container">
          <Row justify="end">
            <Col xs={24} lg={14}>
              <div
                className="pool-content text-center"
                data-aos="fade-up"
                data-aos-delay="300"
              >
                <div className="section-heading text-center white">
                  ...
                  <h2>Hồ Bơi Vô Cực</h2>
                  <p>
                    Tận hưởng những giây phút thư giãn tuyệt vời tại hồ bơi vô
                    cực với tầm nhìn panorama tuyệt đẹp. Được thiết kế hiện đại,
                    hồ bơi mang đến không gian nghỉ dưỡng lý tưởng cùng các dịch
                    vụ cao cấp. Hãy đắm mình trong làn nước trong xanh và tận
                    hưởng khoảnh khắc bình yên.
                  </p>
                </div>
      ...
      <section className="contact-area d-flex flex-wrap align-items-center">
        <div className="home-map-area" data-aos="fade-right">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1861.931965409297!2d105.7459743385597!3d21.038129795153385!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x313455e940879933%3A0xcf10b34e9f1a03df!2zVHLGsOG7nW5nIENhbyDEkeG6s25nIEZQVCBQb2x5dGVjaG5pYw!5e0!3m2!1svi!2s!4v1766418091289!5m2!1svi!2s"
            width="600"
            height="450"
            style={{ border: 0 }}
            allowfullscreen=""
          ...
          <div className="single-contact-information">
            <div className="section-heading">
              ...
              <p>
                ...
                chúng tôi qua bất kỳ kênh nào dưới đây để được tư vấn và đặt
                phòng. Đội ngũ của chúng tôi sẽ phản hồi nhanh chóng và nhiệt
                tình.
              </p>
            </div>

            <h4 className="mt-50">
              Số 13 Phố Trịnh Văn Bô, Nam Từ Liêm, Hà Nội
            </h4>

            <h5 className="mt-30">+84 4196890</h5>

            <h5>bookstayproject@gmail.com</h5>

            <div className="social-info mt-50">
              <a href="#">
                <i className="fa-brands fa-pinterest" aria-hidden="true"></i>
              </a>
              <a href="https://www.facebook.com/storeFW">
