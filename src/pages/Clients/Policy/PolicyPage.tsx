...
const PolicyPage: React.FC = () => {
  const policies = [
    {
      ...
      color: '#cb8670',
      items: [
        'Khách vui lòng đặt cọc 30–50% tổng giá trị đơn đặt phòng để giữ phòng.',
    ...
    },
    {
      ...
      color: '#d89070',
      items: [
        'Chỉ nhận thú cưng nhỏ (dưới 10kg).',
        'Khách phải quản lý thú cưng, không để cào phá đồ đạc hoặc làm ồn.',
        'Nếu gây hư hại, homestay sẽ tính phí sửa chữa theo thực tế.',
        'Không cho thú cưng lên giường, ghế sofa (trừ khi có thỏa thuận riêng).'
      ]
    },
    {
      id: 7,
    ...
    },
    {
      ...
      items: [
        ...
        'Xe ô tô (nếu có chỗ) có thể phụ thu 30.000 – 50.000đ/đêm.',
  ...
  return (
    <Layout>
      ...
      {/* Footer Note */}
      <Content style={{ padding: '0 50px 80px', background: '#fff' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <Card 
            style={{ 
              borderRadius: '12px', 
