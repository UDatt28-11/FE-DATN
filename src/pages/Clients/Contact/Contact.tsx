  ...
  const contactInfo = [
    {
      ...
      title: "Điện thoại",
      details: ["+84 359788023", "+84 34196890"],
    },
    {
      icon: <MailOutlined style={{ fontSize: 32, color: "#cb8670" }} />,
      title: "Email",
      details: ["homestay.vn", "bookstayproject@.com"],
    },
    {
      icon: <EnvironmentOutlined style={{ fontSize: 32, color: "#cb8670" }} />,
      title: "Địa chỉ",
      details: ["Số 13 Phố Trịnh Văn Bô, Nam Từ Liêm, Hà Nội"],
    },
    {
    ...
    <div style={{ fontFamily: '"Times New Roman", Times, serif' }}>
        ...
        <div style={styles.heroContent}>
          ...
          <Breadcrumb
            ...
            items={[
              ...
              {
                title: (
                  <span style={{ color: "#fff", fontSize: 15 }}>Liên hệ</span>
                ),
              },
            ]}
          />
      ...
      <section style={{ padding: "100px 0", background: "#f8f9fa" }}>
        ...
        >
          ...
          <div style={{ textAlign: "center", marginBottom: 60 }}>
            ...
            >
              Hãy liên hệ với chúng tôi qua các kênh dưới đây. Đội ngũ của chúng
            ...
            {contactInfo.map((info, index) => (
              <Col xs={24} sm={12} lg={6} key={index}>
                <div className="contact-info-box" style={styles.infoBox}>
                  ...
                  <Title
                    level={4}
                    style={{ fontSize: 20, marginBottom: 15, color: "#1a1a1a" }}
                  >
                    {info.title}
                  </Title>
                ...
                >
                  <div
                    style={{
                      ...
                      borderRadius: "50%",
                      background:
                        "linear-gradient(135deg, #cb8670 0%, #e0a090 100%)",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      flexShrink: 0,
                  ...
                  <div>
                    ...
                    <Title
                      level={3}
                      style={{ color: "#fff", margin: 0, fontSize: 26 }}
                    >
                      1900 123 456
                    </Title>
                  </div>
      ...
      >
        ...
        >
          ...
          >
            Đặt phòng ngay hôm nay để nhận ưu đãi đặc biệt từ Homestay của chúng
            tôi
          </Paragraph>
          <Link to="/rooms">
            <Button
